...
import com.newapp.motivation.repository.Mock
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        imageAll.setColorFilter(resources.getColor(R.color.rose))
        handleNewPhrase()
    ...
    private fun handleFilter(id: Int) {
        ...
        when (id) {
            ...
            R.id.imageHappy -> {
                imageHappy.setColorFilter(resources.getColor(R.color.rose))
                mPhraseFilter = MotivationConstants.PHRASEFILTER.HAPPY
            }
            R.id.imageMorning -> {
                imageMorning.setColorFilter(resources.getColor(R.color.rose))
